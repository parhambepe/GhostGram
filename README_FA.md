...
| `222` یا `222 <ساعت>` | - | گروه/پیوی | **خلاصه گفتگو (جدید)**: جمع‌بندی خودمونی اتفاقاتی که در ۱۲ ساعت گذشته (یا بازه دلخواه تا ۷۲ ساعت) از دست شما رفته + اشاره به پیام‌هایی که منتظر جواب شما بوده‌اند. |
| `112 <سؤال>` | - | هرجا | **جستجوی وب (جدید)**: پاسخ به‌روز با جستجوی گوگل (قیمت ارز، آب‌وهوا، اخبار و...). روی یک پیام هم می‌توانید ریپلای کنید تا درباره همان سؤال بگیرد. |
| `555 <یادآور>` | - | چت جاری | **یادآور هوشمند (جدید)**: مثلاً `555 ساعت 21 به علی بگو تماس بگیره` یا `555 تا ۲ ساعت دیگه دارو بخور`. یادآورها بعد از ری‌استارت هم حفظ می‌شوند. |

### 👁️ درک چندرسانه‌ای (جدید)
